...
Code to train a Support Vector Machine using 5-fold crossvalidation to classify
...
for i, (train_indices, val_indices) in enumerate(kfold_cv.split(train_val_text)):
    ...
    # We have to transform our data into numeric vectors for the SVM
    ...
    # Initialize SVM classifier and fit it on the tf-idf training data
