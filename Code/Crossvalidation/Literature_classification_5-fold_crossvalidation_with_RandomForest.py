...
Code to train a Random Forest model using 5-fold crossvalidation to classify
...
for i, (train_indices, val_indices) in enumerate(kfold_cv.split(train_val_text)):
    ...
    # We have to transform our data into numeric vectors for the Random Forest
    ...
    # Initialize RandomForest classifier and fit it on the tf-idf training data
