# -*- coding: utf-8 -*-
"""
Created on Thu Jan  9 15:05:07 2020

@author: bulk007

Code to train Naive Bayes using 5-fold crossvalidation to classify papers in a
...
for i, (train_indices, val_indices) in enumerate(kfold_cv.split(train_val_text)):
    ...
    # We have to transform our data into numeric vectors for the Multinomial BN
    ...
    # Initialize Multinonimal BN classifier and fit it on the tf-idf training data
