# -*- coding: utf-8 -*-
"""
Created on Thu Feb 27 15:04:35 2020

@author: bulk007

Code to train a final Naive Bayes model on all available training data, 
based on the best parameters found during crossvalidation, to classify
papers in a specific topic as "Relevant" or "Not relevant" based on
...
# Initialize Naive Bayes classifier and fit it on the tf-idf training data
