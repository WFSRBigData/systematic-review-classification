# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 16:36:57 2020

@author: bulk007

Code to train a final RandomForest model on all available training
data, based on the best parameters found during crossvalidation, to 
classify papers in a specific topic as "Relevant" or "Not relevant"
...
# Initialize Random Forest classifier and fit it on the tf-idf training data
