# -*- coding: utf-8 -*-
"""
Created on Thu Feb  6 16:12:45 2020

@author: bulk007

Code to train a final Logistic Regression model on all available training
data, based on the best parameters found during crossvalidation, to 
classify papers in a specific topic as "Relevant" or "Not relevant" based on
