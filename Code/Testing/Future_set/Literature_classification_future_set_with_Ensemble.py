# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 09:59:54 2020

@author: bulk007

Code to test a specified ensemble of trained models to classify papers on a
data set from later years than were available in the original data, in a
specific topic as "Relevant" or "Not relevant" based on their title and
abstract. The used literature data has been selected from academic databases
...
plt.savefig(os.path.join(result_path, "Future_set_ROC_{}_{}.png".format(model_name,"_".join(models))))
plt.show()

# Save the final results in a .txt file
results_file = open(os.path.join(result_path, "Future_set_results_{}_{}.txt".format(model_name,"_".join(models))), 
                    'w', encoding="utf8")
